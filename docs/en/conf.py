...
autodoc_mock_imports = ['json_tricks', 'uniweat.version']
...
html_theme_options = {
    ...
    'logo_url': 'https://UniWeat.readthedocs.io/en/latest/',
    ...
    'menu': [
        ...
        },
        {
            ...
            'children': [
                # {
                #     'name': 'UniWeat: Simpler yet Better Video Prediction',
