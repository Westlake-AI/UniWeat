...
def load_data(batch_size,
    ...
    train_set = MVWeatherBenchDataset(data_root=weather_dataroot,
                               data_name=data_name, data_split=data_split,
                               training_time=train_time,
                               idx_in=idx_in,
                               idx_out=idx_out,
                               step=step, use_augment=use_augment)
    vali_set = MVWeatherBenchDataset(weather_dataroot,
                              data_name=data_name, data_split=data_split,
                              ...
                              mean=train_set.mean,
                              std=train_set.std)
    test_set = MVWeatherBenchDataset(weather_dataroot,
